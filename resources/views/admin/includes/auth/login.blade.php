            ...
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    <div class="card-title text-center">
                        <div class="p-1">
                            <img src="../../super_mart/assets/admin/images/logo/logo.png" alt="LOGO"/>
                        </div>
                    </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal form-simple" action="{{ route('admin_handleLogin') }}" method="post" novalidate>
                            @csrf
